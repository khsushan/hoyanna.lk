            ...
            <div class="container">
                ...
                <nav class="collapse navigation navbar-collapse navbar-right" role="navigation">
                    <ul id="nav" class="nav navbar-nav" style="color:black">
                        <li><a style="color:black" href="#vacancies">Event</a></li>
                        <li><a style="color:black" href="#stats">Event Calendar</a></li>
                    </ul>
                </nav>
                <!-- /main nav -->
            </div>
    ...
    <section id="vacancies">
        <div class="container">
                    ...
                    <div id="testimonial" style="margin-top:-50px">    
                        ...
                        foreach ($events as $event):
                            ...
                            <a href="#" onclick="showVacancies(this)">                                
                                <div class="tst-single clearfix" id="<?= $event['id']; ?>">
                                    ...
                                    <div class="tst-content">
                                        ...
                                        <p><b>Start Time </b>  : <?= $event['starttime']; ?></p>
                                        <p><b>End time </b>  : <?= $event['endtime']; ?></p>
                                        <span style="margin-top: 7px"> <b>Event Organizer  </b> : <?= $event['username']; ?></span>
                                    </div>
                                </div>
                            </a>
                            <?php
            ...
            <div class="col-md-5 col-md-offset-1 wow fadeInRight">
                ...
                <div class="subtitle text-center">
                    <h4>Event Subcribers Details</h3>
                    <p></p>
                </div>
